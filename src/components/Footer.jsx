...
<footer className="bg-primary/80">
  <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
    <div className="mx-auto max-w-md">
      <strong className="block text-center text-xl font-bold text-secondary sm:text-3xl">
      ...
      <form className="mt-6">
        <div className="relative max-w-lg">
          ...
          <button
            className="absolute end-1 top-1/2 -translate-y-1/2 rounded-full bg-red px-5 py-3 text-sm font-medium text-white transition"
          >
            Subscribe
          </button>
        </div>
      ...
      <div className="text-center  lg:text-left">
        <div>
          ...
          <ul className="mt-6 space-y-1">
            ...
            <li key={idx} className="text-secondary/70 transition hover:text-gray-700/75">
              {service}
            </li>
            ))}
